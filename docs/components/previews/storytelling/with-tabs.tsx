...
function NarrativeContent() {
    ...
    return (
      <div className="space-y-3">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground">
          Define semantic colors and typography scales once. Your entire
          component tree responds dynamically to theme shifts and dark mode.
        </p>
      </div>
    )
  }
  ...
  if (activeStep === 1) {
    return (
      <div className="space-y-3">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground">
          Separate UI rendering from state machines. Easily swap backend
          providers or custom authentication adapters without rewriting views.
        </p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-sm leading-relaxed text-muted-foreground">
        Accessible, responsive, and rigorously tested components ready to drop
        into any Next.js, Vite, or Remix application.
      </p>
    </div>
  )
}
      ...
      <div className="space-y-2 p-2">
        ...
        <div className="rounded-lg border border-border/70 bg-muted/40 p-2.5 font-mono text-xs text-muted-foreground">
          <p className="text-foreground">
            const &#123; activeStep, scrollToStep &#125; = useStorytelling()
          </p>
        </div>
      </div>
    )
  ...
  return (
    <div className="space-y-2 p-2 text-center">
      ...
      <p className="text-[11px] text-muted-foreground">
        Zero bundle bloat, copy-paste ready
      </p>
    </div>
  )
}
        ...
        <StorytellingHeader>
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Interactive tab &amp; scroll navigation
            </p>
          </div>
